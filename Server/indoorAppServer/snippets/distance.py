...
distances_list = list()
for i in np.arange(room_limit_x_min,room_limit_x_max,0.1):
    for j in np.arange(room_limit_y_min,room_limit_y_max,0.1):
        distances = {}
...
display(dataframe)
dataframe.to_csv(r'.\trilateration_test_0.10_meters.csv', index = False)