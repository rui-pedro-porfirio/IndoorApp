...
import android.example.findlocation.ui.tabs.TabTrilaterationOnlinePreferences;
import android.example.findlocation.ui.tabs.TabTrilaterationPosition;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                ...
                return tab1;
            case 1:
                TabTrilaterationOnlinePreferences tab2 = new TabTrilaterationOnlinePreferences();
                return tab2;
            default:
                return null;
        }
